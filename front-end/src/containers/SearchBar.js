      ...
      <div className="SearchBar SearchBarCustom">
        ...
        {showToolTip == 1 && window.innerWidth > 768 && (
          <Tooltip
            anchorId="searchBar"
            place="bootom"
            html={`<h4 class="tooltipHead">Search bar</h4><p class="tooltipContent">Search for other users</p><div class="toolBottom"><span>1/6</span><div class=toolButton><button class="editComm_btn tooltipbtn" id="tooltipSkip">Skip</button><button class="btn btnColor tooltipbtn" id="tooltipNext1">Next</button></div></div>`}
            arrow="arrow"
